...
import img from "../assets/img/foods3.png";
    ...
    return (
        ...
        >
            <img
                ...
                alt="img"
            />
            <h1 className="font-semibold text-2xl text-primary group-hover:text-black">{title}</h1>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Saiente, cumque!</p>
